...
public:
    ...
    setSound() {
        c.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/catch.ogg");
        e.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/egg.ogg");
        g.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Gamegameover.ogg");
        p.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/pass.ogg");
        cah.setBuffer(c);
        egg.setBuffer(e);
...
int main()
{
    ...
    Texture f;
    f.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/fon.png");
    Sprite fon(f);
    Texture p, r;
    p.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/player.png");
    r.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/arm.png");
    Player player(p, r);
    Texture eg;
    eg.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/egg.png");
    int nom[4];
    Egg egg[4];
    for (int i = 0; i < 4; i++) {
        nom[i] = i + 1;
    ...
    int fal = rand() % 4;
    Texture s;
    s.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/score.png");
    Score score(s);
    Texture up;
    up.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/fal.png");
    Upast upast;
    upast.set(up);
    Texture l;
    l.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/lose.png");
    Sprite lose[3];
    for (int i = 0; i < 3; i++) {
        lose[i].setTexture(l);
    ...
    int prop = 0;
    Texture go;
    go.loadFromFile("/Users/moldirsatybaldiyeva/Documents/Game/gameover.png");
    Sprite gameover(go);
